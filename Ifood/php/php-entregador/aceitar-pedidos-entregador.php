...
<body>
    ...
    $sqlPedido = "SELECT * FROM infoPedido WHERE status='Pronto'";
    ...
    <div class="corpo">
        ...
        <div class="cardapio">
            ...
            <div class="pedido">
                ...
                <?php } ?>
                <a
                    href="../php-pedido/mudar-status-pedido.php?id=<?php echo$idPedido?>&idE=<?php echo $idEntregador?>&acao=aceito">Aceitar
                    Pedido<a>
            </div>
            <?php } ?>
        </div>
