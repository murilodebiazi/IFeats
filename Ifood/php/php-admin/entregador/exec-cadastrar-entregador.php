...
$sql = "INSERT INTO Entregador (nomeEntregador, CPFEntregador, emailEntregador, senhaEntregador, transporte, disponivel, avaliacao) VALUES ('$nome','$cpf','$email','$senha_hash','$veiculo','$disponivel','$avaliacao')";
