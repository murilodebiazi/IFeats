        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <?php echo htmlspecialchars($linha['nomeEntregador']); ?>
              </td>
              <td>
                <?php echo htmlspecialchars($linha['CPFEntregador']); ?>
              </td>
              <td>
                <?php echo htmlspecialchars($linha['transporte']); ?>
              </td>
              <td>
              ...
              <td class="actions">
                <a href="form-editar-entregador.php?id=<?php echo $linha['idEntregador']; ?>"
                  class="btn small">Atualizar</a>
                <a href="confirmar-excluir-entregador.php?id=<?php echo $linha['idEntregador']; ?>"
