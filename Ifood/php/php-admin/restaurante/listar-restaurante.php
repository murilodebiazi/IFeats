        ...
        <tbody>
          <?php while ($linha = mysqli_fetch_assoc($resultado)) { ?>
            <tr>
              ...
              <td><?php echo htmlspecialchars($linha['nomeRestaurante']); ?></td>
              <td><?php echo htmlspecialchars($linha['cnpj']); ?></td>
              <td><?php echo htmlspecialchars($linha['telefoneRestaurante']); ?></td>
              <td><?php echo htmlspecialchars($linha['emailRestaurante']); ?></td>
              ...
              <td><?php echo htmlspecialchars($linha['enderecoRestaurante']); ?></td>
              <td class="actions">
                <a href="form-editar-restaurante.php?id=<?php echo $linha['idRestaurante']; ?>" class="btn small">Atualizar</a>
                <a href="confirmar-excluir-restaurante.php?id=<?php echo $linha['idRestaurante']; ?>" class="btn small danger">Excluir</a>
              </td>
            </tr>
          <?php } ?>
        </tbody>
