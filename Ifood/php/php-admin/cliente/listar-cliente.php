        ...
        <tbody>
          <?php while ($linha = mysqli_fetch_assoc($resultado)) { ?>
            <tr>
              ...
              <td><?php echo htmlspecialchars($linha['nomeCliente']); ?></td>
              <td><?php echo htmlspecialchars($linha['telefoneCliente']); ?></td>
              <td><?php echo htmlspecialchars($linha['CPFCliente']); ?></td>
              <td><?php echo htmlspecialchars($linha['emailCliente']); ?></td>
              <td class="actions">
                <a href="form-editar-cliente.php?id=<?php echo $linha['idCliente']; ?>" class="btn small">Atualizar</a>
                <a href="confirmar-excluir-cliente.php?id=<?php echo $linha['idCliente']; ?>" class="btn small danger">Excluir</a>
              </td>
            </tr>
          <?php } ?>
        </tbody>
